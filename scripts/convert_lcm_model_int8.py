...
# prompt = "a beautiful pink unicorn"
...
# int8
UNET_INT8_OV_PATH = Path("../models/lcm/dreamshaper_v7/INT8_dyn/unet/openvino_model.xml")
...
if UNET_INT8_OV_PATH.exists():
    ...
    quantized_unet = nncf.quantize(
        ...
        advanced_parameters=nncf.AdvancedQuantizationParametersfint8_pipe(
...
'''
# here could also run the python pipeline
unet_optimized = core.compile_model(UNET_INT8_OV_PATH)
